...
//import logoImage from "@/assets/images/sphereal-logo.svg?url"; // لا نريد الـ SVG كعنصر، بل كـ URL
        ...
        <div className="container">
          <div className="h-18 lg:h-20 flex justify-between items-center">
              ...
              <nav className="h-full">
                {navItems.map(({ name, href }) => (
                  <a
                    href={href}
                    key={href}
                    // رسم خط عمودي 1px قبل وبعد (آخر عنصر) الاسم بلون gray-200
            ...
            <div className="flex items-center lg:hidden">
              {/* التدرج الخطي ينشئ خلفية لونية صلبة تغطي منطقة محتوى الزر (content-box) */}
              {/* التدرج المخروطي يطبق تدرجًا مخروطيًا على الزر بالكامل بما في ذلك الحدود (border-box) */}
              <button
                className="
